...
//go:generate swagger generate server --target ../../app --name Nutanix --spec ../../../swagger.yaml --template-dir /home/jensg/go/src/github.com/direktiv-apps/nutanix/build/templates --principal interface{}

func configureFlags(api *operations.NutanixAPI) {
...
func configureAPI(api *operations.NutanixAPI) http.Handler {
